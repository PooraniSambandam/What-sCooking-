...
public class CreateAccountActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText mNameEditText = (EditText)findViewById(R.id.nameEditText);
    EditText mEmailEditText = (EditText) findViewById(R.id.emailEditText);
    EditText mPasswordEditText=(EditText) findViewById(R.id.passwordEditText);
    EditText mConfirmPasswordEditText = (EditText) findViewById(R.id.confirmPasswordEditText);
