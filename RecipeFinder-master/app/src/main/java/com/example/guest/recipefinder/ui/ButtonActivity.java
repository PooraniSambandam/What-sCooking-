...
public class ButtonActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void calculatePentagonVertices(int radius, int rotation) {
        ...
        for (int i = 0; i < buttons.length; i++) {
            ...
            buttons[i] = new Button(ButtonActivity.this);
             ...
             */
            ((RelativeLayout) findViewById(R.id.activity_button)).addView(buttons[i]);
        }
        buttons[0].setText("Text");
        buttons[1].setText("Image");
        buttons[2].setText("Voice");
                ...
                if (!isFabClicked) {
                    switch ((int) view.getTag()) {
                        case 0:
                            ...
                            //Intent ContactsOption=new Intent(ButtonActivity.this,TextInput.class);
                            //startActivity(ContactsOption);
                            break;
                        case 1:
                            Toast.makeText(this, "Button 2 clicked", Toast.LENGTH_SHORT).show();
                            optionName.putString("option","Image");
                            //NavigateSearchcat = new Intent(ButtonActivity.this,SearchSQLiteActivity.class);
                            //NavigateSearchcat.putExtras(optionName);
                            //startActivity(NavigateSearchcat);
                            break;
                        case 2:
                            Toast.makeText(this, "Button 3 clicked", Toast.LENGTH_SHORT).show();
                            optionName.putString("option","Voice");
                            //NavigateSearchcat = new Intent(ButtonActivity.this,SearchSQLiteActivity.class);
                            //NavigateSearchcat.putExtras(optionName);
                            //startActivity(NavigateSearchcat);
                            break;
